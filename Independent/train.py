...
# X1 : image features
# X2 : text features
X1train, X2train, max_length 	=	loadTrainData(path = 'train_data/Flickr_8k.trainImages.txt',preprocessDataReady=False)

X1val, X2val = loadValData(path = 'train_data/Flickr_8k.devImages.txt')
